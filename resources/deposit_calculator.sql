...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-12-2023 a las 05:05:02
...
INSERT INTO `credits_details` (`credit_detail_id`, `week_id`, `credit_people_id`, `credit_detail_description`, `credit_detail_value`) VALUES
(1, 6, 1, '6 CERVEZAS LITRO\r\n4 TABACOS', 14.00),
(2, 6, 2, '2 PILSENER LITRO', 4.00);
...
(18, 'App\\Models\\User', 1, 'auth-token', '6874aa528893f8023e7537057fcf8b7c6041da5b03732c2e9ab419a352c36cd4', '[\"*\"]', '2023-12-28 09:03:45', NULL, '2023-12-27 08:18:23', '2023-12-28 09:03:45');
...
(3, 'PILSENER3', 20.99, 22.00, 'https://i0.wp.com/chiplote.imk3.net/wp-content/uploads/2021/03/Pilsener-Cerveza-330ml-Solo-1.jpg?fit=1200%2C1200&ssl=1', 2),
(4, 'SIEMBRA 1000CC', 20.00, 19.20, 'https://cms-prod.global.ssl.fastly.net/media/08-03-2023-71295dc0-6916-4b34-bfa8-86bc9491aa6d-8cf40bb5.jpeg?width=240&height=240&fit=bounds&canvas=240,240', 1),
...
(7, 'CIGARRILLOS LARK', 40.00, 31.46, 'https://cms-prod.global.ssl.fastly.net/media/09-06-2023-00ad7831-6a8f-4a20-8eac-6961cc8612b4-124377b3.jpeg', 1);
...
INSERT INTO `weeks` (`week_id`, `week_date`, `week_status`) VALUES
(6, '2023-12-28', 1),
(10, '2023-12-27', 1);
...
--
-- Volcado de datos para la tabla `week_details`
--

INSERT INTO `week_details` (`week_detail_id`, `product_id`, `week_id`, `week_detail_quantity`, `week_detail_product_name`, `week_detail_product_sale_price`, `week_detail_product_purchase_price`) VALUES
(5, 4, 6, 1, 'SIEMBRA 1000CC', 20.00, 19.20),
(6, 5, 6, 91, 'PILSENER 1000CC', 22.00, 20.99),
(7, 6, 6, 1, 'CLUB PLATINO 850CC', 29.00, 26.50),
(8, 7, 6, 1, 'CIGARRILLOS LARK', 40.00, 31.46),
(9, 1, 6, 13, 'PILSENER 600C', 16.00, 15.50);
...
--
ALTER TABLE `credits_details`
  MODIFY `credit_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `credits_people`
--
ALTER TABLE `credits_people`
  MODIFY `credit_people_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `week_details`
  MODIFY `week_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
